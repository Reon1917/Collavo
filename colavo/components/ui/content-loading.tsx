  ...
  return (
    <div className={cn("space-y-6 animate-in fade-in duration-700", className)}>
      ...
      <div className="space-y-3">
        <div className="h-8 bg-gradient-to-r from-muted to-muted/60 rounded-lg animate-pulse w-1/3"></div>
        <div className="h-4 bg-gradient-to-r from-muted to-muted/60 rounded animate-pulse w-2/3"></div>
      </div>

      {/* Content Skeleton */}
      <div className="space-y-4">
        <div className="h-4 bg-gradient-to-r from-muted to-muted/60 rounded animate-pulse w-full"></div>
        <div className="h-4 bg-gradient-to-r from-muted to-muted/60 rounded animate-pulse w-5/6"></div>
        <div className="h-4 bg-gradient-to-r from-muted to-muted/60 rounded animate-pulse w-4/6"></div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 mt-6">
        {[...Array(6)].map((_, i) => (
          <div 
            key={i} 
            className="h-48 bg-gradient-to-br from-muted to-muted/60 rounded-lg animate-pulse border border-border"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
        {[...Array(4)].map((_, i) => (
          <div 
            key={i} 
            className="h-20 bg-gradient-to-br from-muted to-muted/60 rounded-lg animate-pulse border border-border"
