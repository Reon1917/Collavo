...
export function CreateProjectModal({ children, onProjectCreated, redirectToProject = false }: CreateProjectModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to the newly created project if enabled
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-[600px] bg-white dark:bg-gray-900 border border-gray-200/60 dark:border-gray-700">
        <DialogHeader>
