...
export function ChatMessage({
  ...
  return (
    ...
    >
      ...
      {!isCurrentUser && (
        <span className="text-xs font-medium text-muted-foreground mb-0.5 ml-8">
          {userName}
        </span>
      )}
      <div className={cn(
        ...
        >
          ...
          <span
            className={cn(
              'absolute top-full mt-1 text-[10px] text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap',
