    ...
    <div className="space-y-4">
      ...
      <div className="relative max-w-lg">
        ...
        <Input
          ...
          className="pl-10 h-10 bg-background border-border focus:bg-background focus:border-primary"
        />
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={filterTimeframe} onValueChange={(value) => setFilterTimeframe(value as 'all' | 'upcoming' | 'past' | 'today')}>
              <SelectTrigger className="w-[140px] h-9 bg-background border-border focus:bg-background focus:border-primary">
                <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="h-9 px-3 bg-background border-border hover:bg-background hover:border-primary"
          >
